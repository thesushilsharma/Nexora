  ...
  return (
    <div className="min-h-screen bg-background/50 pb-12">
      ...
      <div className="bg-gradient-to-b from-background to-background/5">
        ...
        <div className="flex flex-row flex-wrap items-center justify-center sm:justify-center md:justify-center lg:justify-end gap-2 py-2 sm:py-4 z-20 p-2 sm:p-4 mb-1">
          <Button
            size="sm"
            className="backdrop-blur-md border bg-muted shadow-lg hover:bg-accent transition-all w-auto min-w-[8rem] sm:min-w-[10rem]"
          >
        ...
        {/* Thumbnail Slider */}
        <div
          className="embla embla-thumbs overflow-hidden mt-0 lg:-mt-20 relative z-20 container mx-auto px-4"
          ref={thumbsRef}
        >
